...
1. `npm install meshblu-citrix-receiver` or `git clone [GIT_URL]`
1. go into connector folder
1. `meshblu-util register -t device:meshblu-citrix-receiver > meshblu.json`
1. `meshblu-util claim`
1. `npm start` or to start with debug `DEBUG='meshblu-citrix-receiver*' npm start`
